				...
				<fieldset>
					...
					<p className='form__group'>
						<label htmlFor='name'>
							Your name
							<span
								className={validName ? 'form__icon form__icon--valid' : 'hide'}>
								<AiFillCheckCircle />
							</span>
							<span
								className={
									validName || !user ? 'hide' : 'form__icon form__icon--invalid'
								}>
								<FaTimesCircle />
							</span>
						</label>
					...
					<p className='form__group'>
						<label htmlFor='password'>
							Password
							<span
								className={validPwd ? 'form__icon form__icon--valid' : 'hide'}>
								<AiFillCheckCircle />
							</span>
							<span
								className={
